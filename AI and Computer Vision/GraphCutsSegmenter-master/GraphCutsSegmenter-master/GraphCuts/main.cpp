...
// SIGMA: Estimation of the camera noise.  10 is high, but it works well enough.
// Variance in pixel intensity between two similar pixels.
...
void init()
{
	...
	cv::cvtColor(*input_image_grayscale, *input_image_grayscale, cv::COLOR_BGR2GRAY);
